...
def parse():
    ...
    parser.add_argument('-train_path',default='/content/Tree-transform/data/train.txt',help='training data path')
    parser.add_argument('-test_path',default='/content/Tree-transform/data/test.txt',help='testing data path')
